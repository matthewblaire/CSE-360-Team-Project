...
public class EmailAddressRecognizer {
	...
	public static String checkEmailAddress(String input) {
		...
		case 1:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "May only be alphanumberic or special characters, '.' and '@'.\n";
			return emailAddressErrorMessage;
		...
		case 2:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "'@' or '.' must be followed by an alphanumberic character.\n";
			return emailAddressErrorMessage;
		...
		case 3:
			...
			if ((currentChar >= 'A' && currentChar <= 'Z')|| 		// Upper case
					(currentChar >= 'a' && currentChar <= 'z') ||	// Lower case
					(currentChar >= '0' && currentChar <= '9') || (currentChar == '.') || (currentChar == '-') || (currentChar == ' ')) {
			...
			{
				emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
				emailAddressErrorMessage = "May only be alphanumberic or, '.' or '-' followed by an alphanumeric character.\n";
				return emailAddressErrorMessage;
			}
		...
		case 4:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "'-' must be followed by an alphanumberic character.\n";
			return emailAddressErrorMessage;
